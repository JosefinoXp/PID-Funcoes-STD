...
int main() {
    ...
    // total_pixels: total de pixels da imagem
    // soma_pixels: soma dos valores de todos os pixels
    // limiar: valor médio dos pixels
    ...
    for (int i = 0; i < width * height; i++) {
        ...
        // soma_pixels: soma dos valores de todos os tons de cinza dos pixels
        soma_pixels += gray;
    }

    // 
    limiar = soma_pixels / total_pixels;
    ...
    for (int i = 0; i < width * height; i++) {
        ...
        // Se o pixel for menor que o limiar, torna ele preto
        if (gray < limiar) {
        ...
        // Se o pixel for maior que o limiar, torna ele branco
        else {
